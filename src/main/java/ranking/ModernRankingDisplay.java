 ...
 * 现代化排行榜显示界面
 */
public class ModernRankingDisplay {

    /**
     * 封装带排名的排行榜数据
     */
    static class RankedPlayerRecord {
    ...
    public static void showRankingWindow(PlayerRecord.GameMode gameMode) {
        ...
        closeButton.setStyle(ThemeManager.ButtonStyles.PRIMARY);
        closeButton.setOnMouseEntered(e -> closeButton.setStyle(ThemeManager.ButtonStyles.PRIMARY_HOVER));
        closeButton.setOnMouseExited(e -> closeButton.setStyle(ThemeManager.ButtonStyles.PRIMARY));
        closeButton.setOnAction(e -> stage.close());

        // 整体布局
        VBox root = new VBox(35, title, sortBox, table, closeButton);
